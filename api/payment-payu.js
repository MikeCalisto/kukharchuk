export default async function handler(req, res) {
  ...
  try {
    ...
    const siteBase = process.env.NEXT_PUBLIC_SITE_URL || 'https://kukharchuk.vercel.app';
    ...
    const orderPayload = {
      ...
      continueUrl:   `${siteBase}/spalah-pl/thank-you`,
      customerIp,
      merchantPosId: posId,
      description:   'FLESZ OD ZERA — kurs online fotografii ze światłem błyskowym',
      currencyCode:  'PLN',
      totalAmount:   '4900', // 49.00 zł w groszach
      extOrderId,
      buyer: { email, phone, language: 'pl' },
      products: [
        {
          name:      'Kurs online FLESZ OD ZERA — fotografia ze światłem błyskowym',
          unitPrice: '4900',
          quantity:  '1',
        },
      ],
